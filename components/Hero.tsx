...
<div>
<h2 className="text-5xl font-bold mb-4">Desenvolvedor Web Freelancer</h2>
<p className="text-zinc-400 max-w-xl mx-auto mb-8">
Crio aplicações modernas, rápidas e profissionais usando React, Next.js, Node.js e WordPress.
</p>
